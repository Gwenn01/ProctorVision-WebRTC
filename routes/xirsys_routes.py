...
def get_turn_credentials():
    ...
    Requires environment vars: XIRSYS_USER, XIRSYS_SECRET, XIRSYS_CHANNEL
    """
    XIRSYS_USER = os.getenv("XIRSYS_USER")
    XIRSYS_SECRET = os.getenv("XIRSYS_SECRET")
    XIRSYS_CHANNEL = os.getenv("XIRSYS_CHANNEL", "proctorvision")
